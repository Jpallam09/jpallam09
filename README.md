...
- 🔭 Currently building full-stack apps with **MERN** and **Laravel**
- 🌱 Exploring **TypeScript**, **Next.js**, and **cloud deployments**
- ✍️ Occasionally turn dev notes into mini blogs
- ☕ Coffee-powered coder
- 💬 Ask me about **REST APIs**, **auth flows**, or **database design**
...
|--------|-------------|-------|
| 🛒 **E-Commerce App** | Full-featured shopping platform with auth, payments & admin dashboard | MERN |
| ✅ **Task Manager** | CRUD app with advanced user roles and real-time notifications | Laravel, PHP |
| 🌐 **Portfolio** | Personal space to showcase projects and experiments | React, Tailwind |

> 📁 See all projects → [github.com/your-username](https://github.com/your-username)

---

## 📊 GitHub Stats

![JP's GitHub Stats](https://github-readme-stats.vercel.app/api?username=your-username&show_icons=true&theme=tokyonight&hide_border=true)
